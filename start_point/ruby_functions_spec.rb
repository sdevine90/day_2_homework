...
#   end
  ...
  #   new_name_for_function_call = length_of_string( test_string )
  #   assert_equal( 21, new_name_for_function_call )
  # end

  # def test_length_of_string_2()
  #   assert_equal(21, length_of_string("a string of length 21"))
  # end
